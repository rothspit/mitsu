...
export default function NishifunaSchedulePage() {
  ...
  // 週表示: 西船橋エリア行 + area_id 未設定の従来行（null は西船・葛西共通扱いのレガシーデータ）
  ...
  useEffect(() => {
    if (viewMode === 'week') {
      const url = selectedDate === today ? '/nishifuna' : `/nishifuna?date=${selectedDate}`
